                                            ...
                                            <div className="d-flex align-items-center mb-24">
                                                <svg width="60" height="60" viewBox="0 0 60 60" fill="none"
                                                    ...
                                                    <g mask="url(#mask0-category-1)">
                                                        ...
                                                        <path d="M19.5 18.3125L15.5 18.3125" stroke="white" strokeWidth="2.5"
                                                            strokeLinecap="round" strokeLinejoin="round" />
                                                        <path d="M26.4375 29.5L15.5 29.5" stroke="#B7B0F4" strokeWidth="2.5"
                                                            strokeLinecap="round" strokeLinejoin="round" />
                                                    </g>
                                                </svg>
                                                ...
                                                <svg width="60" height="60" viewBox="0 0 60 60" fill="none"
                                                    ...
                                                    <g mask="url(#mask0-category-2)">
                                                        ...
                                                        <path
                                                            ...
                                                            fill="white" />
                                                        <path d="M27 22L17 22" stroke="white" strokeWidth="2.5"
                                                            strokeLinecap="round" strokeLinejoin="round" />
                                                        <path d="M24 27L17 27" stroke="#B7B0F4" strokeWidth="2.5"
                                                            strokeLinecap="round" strokeLinejoin="round" />
                                                    </g>
                                                </svg>
