                    ...
                    <div className="main-content main-content-table overflow-auto">
                        <table className="table table-borderless">
                            ...
                            <tbody id="list_status_item">
                                <TableRow title="Mobile Legend: Bang Bang" thumbnail="overview-1" category="Dekstop" item={200} price={290} status="Pending" />
                                <TableRow title="Call of Duty: Modern War" thumbnail="overview-2" category="Mobile" item={200} price={290} status="Success" />
