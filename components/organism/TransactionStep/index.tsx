            ...
            <section id="feature" className="feature pt-50 pb-50">
                <div className="container-fluid">
                    ...
                    <div className="row gap-lg-0 gap-4" >
                        ...
                        <StepItem icon="step1" title="2.Fill Up" desc1="Top up sesuai dengan" desc2="nominal yang sudah tersedia" />
                        <StepItem icon="step1" title="3. Be a Winner" desc1="Siap digunakan untuk" desc2="improve permainan kamu" />
