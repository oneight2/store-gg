...
export default function CheckoutDetail() {
    ...
    useEffect(() => {
        const getLocalTopup = JSON.parse(localStorage.getItem('topup-data'))
        setDataTopup(getLocalTopup)
    }, [])
    const price = dataTopup.nominalItem.price
    ...
    return (
        <>
            <div className="purchase pt-md-50 pt-30">
                ...
                <p className="text-lg color-palette-1 mb-20">Order ID <span className="purchase-details">{dataTopup.orderID}</span></p>
